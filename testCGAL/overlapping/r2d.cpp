...
void r2d_reduce(r2d_poly* poly, std::vector<r2d_real> &moments, r2d_int polyorder) {
	...
	std::vector<std::vector<r2d_real>> D(polyorder+1, std::vector<r2d_real>(2));
	std::vector<std::vector<r2d_real>> C(polyorder+1, std::vector<r2d_real>(2));
