...
void r3d_reduce(r3d_poly* poly, std::vector<r3d_real> &moments, r3d_int polyorder) {
	...
	std::vector<std::vector<r3d_int>> emarks(*nverts, std::vector<r3d_int>(3, 0));
	...
	std::vector<std::vector<std::vector<r3d_real>>> S(polyorder+1, std::vector<std::vector<r3d_real>>(polyorder+1,std::vector<r3d_real>(2)) ); 
	std::vector<std::vector<std::vector<r3d_real>>> D(polyorder+1, std::vector<std::vector<r3d_real>>(polyorder+1,std::vector<r3d_real>(2)) ); 
	std::vector<std::vector<std::vector<r3d_real>>> C(polyorder+1, std::vector<std::vector<r3d_real>>(polyorder+1,std::vector<r3d_real>(2)) ); 
